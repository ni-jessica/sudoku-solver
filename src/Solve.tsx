...
const SudokuSolver = () => {
  return (
    <div className="container">
      <header className="text-3xl sm:text-5xl drop-shadow-lg text-[#FFBE0B] font-semibold pb-8 condense-text">
        Sudoku solver
      </header>

      <h1 id="status" className="text-base sm:text-lg condense-text">Enter the known numbers</h1>
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-9 condense-text">
